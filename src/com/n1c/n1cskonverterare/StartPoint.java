...
public class StartPoint extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//Set upp en ArrayAdapter till alla spinner-v�rden
		...
		bottomButton.setOnClickListener(new OnClickListener(){
			...
			public void onClick(View arg0) {
				...
				if (editTextInValue.getText().toString().matches(".*\\d.*")){
					...
					CharSequence text = "Inget v�rde angivet";
	...
	public String Calculate(String type, String fran, String till, double value) {
		...
		if (type.equals("Volym")){
			double m, dm, cm, l, g;
			//konvertera "fran" till alla m�jliga enheter 
			if (fran.equals("m^3")){
				m = value;
				dm = m * 1000;
				cm = dm * 1000;
	...
	public boolean onOptionsItemSelected(MenuItem item){
		...
		/*case R.id.prefix:
			Context context = getApplicationContext();
			CharSequence text = "Inst�llningarna excisterar bara i parallella universum.\n\nInst�llningar kommer i framtida versioner.";
